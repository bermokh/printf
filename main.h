...
int print_hexa(va_list types, char map_to[], char buffer[], int flags, int width, int precision, int size);
...
int append_haxa_code(char, char[], int);
int is_digit(char);
